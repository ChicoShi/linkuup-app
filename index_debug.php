...
$v = sprintf("?v=%s-locations-controls378", LUPConfig::$VERSION);
$min = LUPConfig::$MIN;
...
<head>
  ...
  <link rel="stylesheet" href="css/lup-location-stage.css<?=$v?>">
	...
	<link rel="stylesheet" href="css/lup-distance-dialog.css<?=$v?>">
  ...
  <link rel="stylesheet" href="css/lup-location-glass-frame.css<?=$v?>">
...
window.LUP_BUILD = <?=json_encode(LUPConfig::$VERSION . '-locations-controls378')?>;
window.LUP_GOOGLE_MAPS_API_KEY = <?=json_encode($googleMapsApiKey)?>;
  ...
  <script src="js/service/lup-settings-service.js<?=$v?>"></script>
	...
	<script src="js/service/lup-distance-service.js<?=$v?>"></script>
